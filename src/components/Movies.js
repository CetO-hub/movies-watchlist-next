    ...
    return (
      <>
        <div key={movie.imdbID}>
          <div className="w-full flex justify-between gap-5 items-center md:justify-start">
            ...
            <div className=" flex flex-col gap-y-3">
              ...
              <div className="text-xs flex font-roboto gap-2 justify-between md:justify-start md:text-lg">
                ...
                {props.page === "index" ? (
                  ...
                  <a
                    onClick={(e) => props.removeWatchlist(e, movie.imdbID)}
                    className="inline whitespace-nowrap cursor-pointer h-fit"
                  >
                    <AiFillMinusCircle size={20} className="inline" />
                    Remove
                  </a>
                )}
              </div>
          ...
          <div className="mt-4 border-b-2 w-full border-gray-400/50"></div>
        </div>
      </>
    );
  });
